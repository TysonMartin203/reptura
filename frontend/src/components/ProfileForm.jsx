      ...
      <div className="field">
        ...
        <div style={{display:'flex',gap:'14px',alignItems:'flex-start',marginBottom:'8px'}}>
          ...
          <div style={{flex:1}}>
            ...
            <p className="muted" style={{fontSize:'12px'}}>Measured straight across your palm (dotted line), not including your thumb. Used to help the AI judge portion sizes when you scan a food photo with your hand in frame.</p>
          </div>
        </div>
      </div>
      <div className="field">
